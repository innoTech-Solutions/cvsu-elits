...
const Awards = () => {
    const awardsData = [
        ...
        },
        {
            ...
            description:
                "Recognizing exceptional leadership skills and contributions.",
            achievements: 3,
        },
        {
    ...
    return (
        ...
        >
            <h1 className="text-5xl font-bold mb-10 text-[#2F3233]">
                Top Awards
            </h1>
            <div
                ...
                {awardsData.map((award, index) => (
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            >
                                <span className=" font-bold text-5xl text-yellow-500">
                                    {award.achievements}
                                </span>{" "}
                                Achievements
                            </p>
